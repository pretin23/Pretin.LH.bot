   ...
   switch (prefix) {
      ...
      case 'info':
       ...
       case 'ytmp3':
           ytdl('mp3', value)
               .then(data => {
                   ...
                   client.sendMessage(id, '[ESPERE SEU NEGRO...', MessageType.text)
       ...
       case 'twt':
           tweetdl(value)
               .then(data => {
                    ...
                    client.sendMessage(id, '[CARA CHATO AFFS...', MessageType.text)
                    client.sendMessage(id, hasil ,MessageType.text)
               })
               .catch(err => {
                   console.log(err)
       ...
       case 'animepict':
           animPict()
               .then(buffer => {
                   client.sendMessage(id, '[ESPERA...', MessageType.text)
                   client.sendMessage(id, buffer, MessageType.image)
               })
               .catch(err => {
                   console.log(err)
